...
exports.spliter = {
  name: "Расщипитель",
  description: "Разделяет юнита на два. Обе половины нестабильны и вскоре исчезают",
  weight: 100,
  rank: 145,
  class: "norm",
  life: 3,
...
exports.plant = {
  name: "незаполнено",
  description: "Выращивает себе нейтрального друга в любой точке поле, не умеет ходить",
  weight: 50,
  life: 3,
  rank: 60,
  class: "norm",

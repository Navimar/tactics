...
exports.bot = (ctx, bot) => {
  ...
  if (text == "/start") {
    send.bot(
      id,
      "Добро пожаловать в Incredible Tactics. Вам представился шанс продемонстрировать всю глубину тактической мысли игрокам со всего света.\nВызовите /help, чтобы увидеть полный список команд.",
      bot
    );
  ...
  // }
    ...
    let mes =
      "Обучение пока не готово ¯\\_(ツ)_/¯\nВсе вопросы можете задать в нашем чате @IncredibleTacticsChat";
    // mes += '\n\nВам доступны юниты:';
    // arr.forEach((e) => {
